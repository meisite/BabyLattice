...
public class BaoShuiFragment extends BaseFragment {
    ...
    public BaoShuiFragment(List<HomePageProductList> list) {
        this.list = list;
    }

    public BaoShuiFragment() {
    }

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_bao_shui;
    }

    @Override
    protected void initViews() {
        listView = (ListView) view.findViewById(R.id.baoshui_listView);
    }
