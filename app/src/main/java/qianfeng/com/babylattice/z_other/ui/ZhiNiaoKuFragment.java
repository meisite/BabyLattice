...
public class ZhiNiaoKuFragment extends BaseFragment {

    private SideMenu sideMenu;
    private LinearLayout ll;
    private List<SideMenu.CategoryInfoSBean> category_info_s;

    public ZhiNiaoKuFragment(SideMenu sideMenu) {
        this.sideMenu = sideMenu;
    }

    public ZhiNiaoKuFragment() {
    }

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_zhi_niao_ku;
    }

    @Override
    protected void initViews() {
        ll = (LinearLayout) view.findViewById(R.id.zhiniaoku_ll);
    }
